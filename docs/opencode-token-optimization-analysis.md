...
**Ponto-chave para Aru**: O hint instrui o LLM a **nao ler o arquivo inteiro**, mas sim usar ferramentas de busca com offset/limit. Isso evita que o LLM peça re-leitura do conteudo completo.
