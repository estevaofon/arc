...
ARU_DIR = ".aru"
CHROMA_DIR = os.path.join(ARU_DIR, "chroma")
META_FILE = os.path.join(ARU_DIR, "index_meta.json")
CHUNK_SIZE = 1500
CHUNK_OVERLAP = 200
...
def _get_aru_dir() -> str:
    """Get or create the .aru directory relative to cwd."""
    aru_dir = os.path.join(os.getcwd(), ARU_DIR)
